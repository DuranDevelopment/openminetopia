...
public final class TeleporterCreateCommand extends BaseCommand {
    ...
    @Subcommand("create")
    @Syntax("[plate] [roundYaw]")
    public void create(Player player, @Optional PressurePlate plate, @Optional Boolean roundYaw) {
        ...
        ItemStack item = TeleporterUtil.buildPlate(plate, location);
